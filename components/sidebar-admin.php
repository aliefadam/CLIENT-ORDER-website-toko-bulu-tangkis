...
<div class="fixed-top d-flex flex-column flex-shrink-0 p-3 bg-white shadow" style="width: 280px; height: 100vh;">
    <a href=""
        class="d-flex align-items-center justify-content-center mb-3 mb-md-0 link-body-emphasis text-decoration-none text-center">
    ...
    <ul class="nav nav-pills flex-column mb-auto">
        ...
        <li class="nav-item mb-1">
            <a href="index.php" class="nav-link <?= $basename == "index" ? "active" : "" ?> sidebar"
                aria-current="page">
        ...
        <li class="nav-item mb-1">
            <a href="users.php" class="nav-link <?= $basename == "users" ? "active" : "" ?> sidebar"
                aria-current="page">
        ...
        <li class="nav-item mb-1">
            <a href="transaction.php" class="nav-link <?= $basename == "transaction" ? "active" : "" ?> sidebar"
                aria-current="page">
